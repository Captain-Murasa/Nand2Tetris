'''Functionality:
Translate Hack mnemonic(C-Command) to binary code.
'''


class Code:
    dest_table = {'M': '001', 'D': '010', 'DM': '011', 'MD': '011',
    ...
    @staticmethod
    def dest(str):
        return Code.dest_table[str]

    @staticmethod
    def comp(str):
        return Code.comp_table[str]

    @staticmethod
    def jump(str):
        return Code.jump_table[str]
